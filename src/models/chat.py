...
MODEL_STATUS_TIMEOUT_SECONDS = 120
...
async def test_chat_model_status(provider: str, model_name: str) -> dict:
    ...
    try:
        ...
        # 发送测试请求
        status_client = model.client.with_options(timeout=MODEL_STATUS_TIMEOUT_SECONDS, max_retries=0)
        completion = await status_client.chat.completions.create(
