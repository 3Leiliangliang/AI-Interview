# AI-interview Initialization Script for PowerShell
# This script helps set up the environment for the AI-interview project
# Note: API keys will be visible during input - use with care

Write-Host "🚀 Initializing AI-interview project..." -ForegroundColor Cyan
