...
::: tip 提示
除了此文档网站外，用户还可以在 [Zread](https://zread.ai/xerrors/AI-interview) 或 [DeepWiki](https://deepwiki.com/xerrors/AI-interview) 平台查看自动生成的详细项目文档。
:::
...
```bash
# 克隆稳定版本
git clone --branch v0.4.0 --depth 1 https://github.com/xerrors/AI-interview.git
cd AI-interview
```
