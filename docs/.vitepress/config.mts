...
export default defineConfig({
  ...
  themeConfig: {
      ...
      '/latest/': [
        {
          text: '简介',
          items: [
            { text: '什么是 AI-interview？', link: '/latest/intro/project-overview' },
      ...
      '/v0.4.0/': [
        {
          text: '简介',
          items: [
            { text: '什么是 AI-interview？', link: '/v0.4.0/intro/project-overview' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/xerrors/AI-interview' }
    ],


    footer: {
      message: '本项目基于 MIT License 开源，欢迎使用和贡献。',
      copyright: 'Copyright © 2025-present AI-interview'
    },


    editLink: {
      pattern: 'https://github.com/xerrors/AI-interview/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页'
    },
