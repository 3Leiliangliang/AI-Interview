...
1. `/AI-interview/src/services/run_queue_service.py`
2. `/AI-interview/src/services/run_worker.py`
3. `/AI-interview/src/services/agent_run_service.py`
4. `/AI-interview/src/repositories/agent_run_repository.py`
5. `/AI-interview/server/routers/chat_router.py`
6. `/AI-interview/server/worker_main.py`
7. `/AI-interview/src/storage/postgres/manager.py`
8. `/AI-interview/src/storage/postgres/models_business.py`

### 前端

1. `/AI-interview/web/src/apis/agent_api.js`
2. `/AI-interview/web/src/components/AgentChatComponent.vue`

### 测试

1. `/AI-interview/test/test_run_queue_service.py`
2. `/AI-interview/test/test_agent_run_service.py`
3. `/AI-interview/test/test_run_worker.py`

### 配置

1. `/AI-interview/docker-compose.yml`
2. `/AI-interview/docker-compose.prod.yml`
3. `/AI-interview/.env.template`
