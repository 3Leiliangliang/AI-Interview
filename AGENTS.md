...
AI-interview 是一个基于大模型的智能知识库与智能体开发平台，聚焦 RAG、知识库检索与面试场景，基于 LangGraph v1 + Vue.js + FastAPI 架构构建。项目完全通过 Docker Compose 进行管理，支持热重载开发。
...
- 修改完成后使用 AI_INTERVIEW_SUPER_ADMIN_NAME / AI_INTERVIEW_SUPER_ADMIN_PASSWORD 环境变量调试接口（读取 .env 文件）
